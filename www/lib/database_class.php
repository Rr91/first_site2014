<?php
    ...
    class DataBase{
        ...
        public function getBetween($table_name, $field_out, $field_in_1, $value_in_1, $field_in_2, $value_in_2)
        {
            return $this->select($table_name, array($field_out),"`$field_in_1`='".addslashes($value_in_1)."' BETWEEN `$field_in_2`='".addslashes($value_in_2)."'");
        }
        public function getMinValueField($table_name,$field)
        {
            return $this->select($table_name, array(" MIN(`$field`) "));
        }
        public function getMaxValueField($table_name,$field)
        {
            return $this->select($table_name,array(" MAX(`$field`)"));
        }
        ...
        public function search($table_name, $words, $fields){
            ...
            for($i = 0; $i < count($result);$i++){
                ...
                $data[$k] = $result[$i];
                $data[$k]["relevant"] = $this->getRelevantForSearch($result[$i], $fields, $words);
                $k++;
            }
