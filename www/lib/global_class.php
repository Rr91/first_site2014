<?php
    ...
    abstract class GlobalClass{
        ...
        protected function getMinValueField($field)
        {
            return $this->db->getMinValueField($this->table_name, $field);
        }   
        protected function getMaxValueField($field)
        {
            return $this->db->getMaxValueField($this->table_name, $field);
        } 
        protected function getBetween($field_out, $field_in_1, $value_in_1, $field_in_2, $value_in_2)
        {
            return $this->db->getBetween($this->table_name, $field_out, $field_in_1, $value_in_1, $field_in_2, $value_in_2);
        }        
        ...
        {
            return $this->db->getElementOnID($this->table_name, $this->idChange($id));
        }
        ...
        {
            return $this->db->getLastID($this->tadle_name);
        }
